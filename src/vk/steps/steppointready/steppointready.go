package steppointready

import (
	"time"
	vomni "vk/omnibus"
	vpointready "vk/pointready"
	vstep "vk/steps/step"
)
...
func init() {
	ThisStep.Name = vomni.StepNamePointReady
...
func (s *thisStep) stepDo() {
	...
	go vpointready.Prepare(chGoOn, chDone, chErr) // put the right call here
